...
(function() {
  ...
  app.config(function($routeProvider) {
    return $routeProvider.when("/xinchao", {
      template: "xin chao from me"
    }).when('/groups', {
  ...
  this.groupCtrl = function($scope, $resource, $routeParams) {
    var Group, List;

    Group = $resource("/groups/:id");
    List = $resource('/lists/:id', {
      id: '@id'
    }, {
      'get': {
        method: 'GET',
    ...
    $scope.deleteGroup = function(i, g) {
    ...
    $scope.addGroup = function() {
      ...
      if ($scope.groupName) {
        ...
        return $scope.emptyGroupName = "Group name can not be empty";
      }
    };
    $scope.editGroup = function(i) {
      return $scope.currentEditGroup = $scope.groups[i];
    };
    $scope.addList = function() {
      var lastL, n, new_l, nextIndex;
      ...
      if ($scope.listName) {
        ...
        return $scope.emptyListName = "List name can not be empty";
      }
    };
    return $scope.deleteList = function(i, l) {
